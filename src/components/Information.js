    ...
    return (
        <div className="information-container shared-container">
            ...
            <section className="information-section">
                <h2>Underhållning</h2>
                <p>
                    Kvällen kommer styras upp och ledas av våra två stjärnor <b>Mia Hellberg</b> och <b>Hannes Karlström</b>.
                </p>
                <p>
                    Vid planering av diverse spex och/eller tal kan ni kontakta:
                </p>
                <ul>
                    <li><b>E-post:</b> <a href="mailto:miasmejl@mejl.com">miasmejl@mejl.com</a></li>
                    <li><b>Telefon:</b> <a href="tel:07000000000000000">07000000000000000</a></li>
                </ul>
            </section>
            ...
            <section className="information-section">
                <h2>Gåvor</h2>
                <p>
                    Eran närvaro är det viktigaste för oss så gåvor är inget som vi förväntar oss. Om ni mot förmodan vill ge en gåva ändå så skulle vi bli glada om ni bidrog till vår bröllopsresa där vi ska äventyra i Sydamerika. Vi har skapat en insamling som administreras av vår kära Toast Master där ni kan bidra med valfritt belopp. Vi kommer bara se totala summan. Inget annat.
                    <ul>
                        <li><b>Gåvan kan ges via Swish till:</b> <a href="tel:07000000000000000">07000000000000000</a></li>
                    </ul>
                </p>
            </section>
            <section className="information-section">
